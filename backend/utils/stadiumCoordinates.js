// Stadium coordinates (SVG pixel coordinates from map)
// These represent the visual positions of teams on the map
// Used for A* heuristic calculation
...
module.exports = { stadiumCoordinates };
